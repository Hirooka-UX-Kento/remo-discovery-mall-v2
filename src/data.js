...
export const STORES = [
  ...
  ["osaka", "Nipponbashi Remote Arcade", "大阪 / 日本橋", "Osaka / Nipponbashi", "トレカ・コレクタブル", "Trading cards, collectibles", "スタッフ確認の限定品", "Staff-confirm showcase", 43, 60],
  ["sapporo", "Sapporo Snow Pop Base", "北海道 / 札幌", "Hokkaido / Sapporo", "雪まつりグッズ", "Snow festival goods", "北限定アクリルセット", "Northern limited acrylic", 68, 22],
  ["kanazawa", "Kanazawa Craft Toy Vault", "石川 / 金沢", "Ishikawa / Kanazawa", "工芸トイ・職人チャーム", "Craft toys, artisan charms", "金箔カプセルチャーム", "Gold-leaf capsule charm", 50, 50],
  ["fukuoka", "Hakata Pop Relay", "福岡 / 博多", "Fukuoka / Hakata", "ローカルコラボグッズ", "Local collab goods", "九州プレイヤー協力棚", "Kyushu co-op shelf", 18, 66],
  ["okinawa", "Naha Culture Station", "沖縄 / 那覇", "Okinawa / Naha", "島ポップ土産", "Island pop souvenirs", "南国カラーバッジ", "Tropical color badge", 82, 68],
  ["nagoya", "Nagoya Mecha Market", "愛知 / 名古屋", "Aichi / Nagoya", "ロボ・ガレキ", "Robots, garage kits", "メカ試作コーナー", "Mecha prototype corner", 56, 57],
  ["sendai", "Sendai Retro Capsule", "宮城 / 仙台", "Miyagi / Sendai", "レトロトイ・カプセル", "Retro toys, capsules", "アーカイブカプセル壁", "Archive capsule wall", 60, 41],
  ["hiroshima", "Hiroshima Peace Hobby Port", "広島 / 本通", "Hiroshima / Hondori", "ミニチュア・カード", "Miniatures, cards", "港限定ミニチュア", "Port-only miniature", 31, 63]
